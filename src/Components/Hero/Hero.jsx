  ...
  return (
    ...
    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-relaxed tracking-tight text-white uppercase md:text-5xl xl:text-6xl dark:text-white">hi, i am 
            Mahmoud Raslan
            </h1>
        ...
        <div className="mt-6 lg:mt-0 lg:col-span-5 lg:flex ">
            <img className="shadow-lg rounded-3xl" src={myImage} alt="myImage"/>
        </div>                
    </div>
</section>
    </div>
